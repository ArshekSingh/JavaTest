...
public class DateTimeUtil {
    ...
    public static final String IBL_UPI_FORMAT = "yyyy-MM-dd'T'HH:mm:ss";

    private static final DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm");

    private static final DateTimeFormatter iblDateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
    ...
    public static String getDateTimeAfterXMinutes(Date date, int minutes, String dateFormat) {
        return DateTimeUtil.format(DateUtils.addMinutes(date, minutes), dateFormat);
    }
}
